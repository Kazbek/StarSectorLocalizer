...
namespace CsvDiffExplorer.FileSpecifics.data.strings
{
    internal class descriptions
    {
        public static void Process()
        {
            ...
            var dtNewVersion = CsvUtils.Read(@"C:\StarSectorPlayground\StarSector 0.95.1a-RC6\original\starsector-core\data\strings\descriptions.csv");
