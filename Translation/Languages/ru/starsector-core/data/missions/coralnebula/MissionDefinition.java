...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "Оперативная группа Союза Персея во главе с Mars Kato");
		api.setFleetTagline(FleetSide.ENEMY, "Отряд из 3-й Священной Армады и нерегулярных войск");
		
		// These show up as items in the bulleted list under 
		// "Tactical Objectives" on the mission detail screen
		api.addBriefingItem("Использование ваших торпедоносцев - ключ к победе");
		api.addBriefingItem("Задача авианосца 'Sirocco' Astral класса, поддержание непрерывной работы истребителей. Пожалуйста позаботьтесь об этом");
		api.addBriefingItem("Победить все силы противника");
