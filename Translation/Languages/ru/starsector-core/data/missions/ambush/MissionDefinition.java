...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "Три-Тахионнская группа фазовых Gamma III");
		api.setFleetTagline(FleetSide.ENEMY, "Специальные анти-рейдерские патрульные Гегемонии");
		
		// These show up as items in the bulleted list under 
		// "Tactical Objectives" on the mission detail screen
		api.addBriefingItem("Уничтожить все вражеские силы");
		api.addBriefingItem("Используйте Sabot SRMs для перегрузки целей, прежде чем добивать их торпедами Reaper");
		api.addBriefingItem("Remember: вашей броне не страшен урон от противоистребительных ракет");
