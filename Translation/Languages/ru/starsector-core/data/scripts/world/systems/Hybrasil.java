	...
	// Elada System 
		...
		// & the moons of Elada
			...
			hybrasil2a.setInteractionImage("illustrations", "eochu_bres");
				...
				SectorEntityToken eochu_bres_mirror1 = system.addCustomEntity("eochu_bres_mirror1", "Звездное Зеркало Eochu Bres", "stellar_mirror", "tritachyon");
				...
				SectorEntityToken eochu_bres_mirror2 = system.addCustomEntity("eochu_bres_mirror2", "Звездное Зеркало Eochu Bres", "stellar_mirror", "tritachyon");
				...
				SectorEntityToken eochu_bres_mirror3 = system.addCustomEntity("eochu_bres_mirror3", "Звездное Зеркало Eochu Bres", "stellar_mirror", "tritachyon");
			...
			SectorEntityToken relay = system.addCustomEntity("elada_relay", // unique id
					 "Ретрансляционная станция связи Elada", // name - if null, defaultName from custom_entities.json will be used
...
//		hybrasil3.setInteractionImage("illustrations", "mine");
		...
		JumpPointAPI jumpPoint = Global.getFactory().createJumpPoint("hybrasil_inner_jump", "Точка перехода внутренней системы Hybrasil");
