...
public class Isirah {
	...
	public void generate(SectorAPI sector) {
		...
		JumpPointAPI jumpPoint2 = Global.getFactory().createJumpPoint("isirah_jump", "Точка перехода внутренней системы Isirah");
		...
		SectorEntityToken station1 = system.addCustomEntity("laicaille_habitat", "Laicaille Среда обитания", "station_side00", "persean");
		...
		SectorEntityToken station2 = system.addCustomEntity("station_kapteyn", "Kapteyn Промышленная станция", "station_mining00", "pirates");
		...
		SectorEntityToken gate = system.addCustomEntity("isirah_gate", // unique id
				 "Врата Isirah", // name - if null, defaultName from custom_entities.json will be used
		...
		SectorEntityToken station3 = system.addCustomEntity("groombridge_habitat", "Groombridge Среда обитания", "station_side00", "neutral");
