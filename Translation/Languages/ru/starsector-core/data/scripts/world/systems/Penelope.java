...
//		system.addRingBand(penelope_star, "misc", "rings_asteroids0", 256f, 3, Color.white, 256f, 13750, 345f, Terrain.ASTEROID_BELT, null);
		...
		penelope3.setCustomDescriptionId("planet_ogygia");
			...
			JumpPointAPI p_jumpPoint = Global.getFactory().createJumpPoint("penelope_jump", "Penelope's Внутренняя точка прыжка");
		...
		// Telepylus station : staging area for volatiles transport Oxen
			SectorEntityToken telepylus_station = system.addCustomEntity("telepylus_station", "Telepylus Космическая станция", "station_sporeship_derelict", "neutral");
		...
		// Outer system jump-point
			...
			JumpPointAPI p_jumpPoint2 = Global.getFactory().createJumpPoint("penelope_jump", "Penelope's Внешняя точка перехода");
